...
// Lectura de variables con referencias ESTÁTICAS (process.env.NOMBRE): en el middleware de Vercel (Edge)
// solo se sustituyen las referencias escritas así; una lectura dinámica process.env[name] llega vacía.
function readEnv() {
  try {
    return {
